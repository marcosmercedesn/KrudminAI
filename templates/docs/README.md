# Host-App Documentation Package

This documentation package is managed by KrudminAI generators. Refresh it with `rails generate krudmin_ai:docs_sync`; host documentation outside this package and content outside the managed `AGENTS.md` marker remain untouched.
